...
function ensureProductHeader(){
  ...
  header.innerHTML = `
    ...
    <div class="header-actions">
      ...
      <a class="icon-button cart-link" href="#contact" aria-label="Voir les produits"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 4h2l2.1 10.1a2 2 0 0 0 2 1.6h7.8a2 2 0 0 0 1.9-1.4L20.5 8H6"></path><circle cx="9.5" cy="19" r="1.2" class="fill"></circle><circle cx="17.5" cy="19" r="1.2" class="fill"></circle></svg><span class="cart-badge">0</span></a>
