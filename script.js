...
(function addOilAmlouCategory(){
  ...
  section.dataset.section='huiles';
  section.id='huiles';
  section.innerHTML=`
    <div class="category-heading"><div class="category-heading-left"><span class="category-number">08</span><div><span class="product-item-tag">UNIVERS ARAOUAA</span><h2>Huiles <em>&amp; Essences</em></h2></div></div><p>Une sélection d’huiles alimentaires inspirées du terroir marocain, entre caractère, finesse et savoir-faire.</p></div>
    <div class="product-items">
      <article class="product-item" data-product-name="Huile d’argan"><div class="product-item-image"><div class="product-placeholder"><strong>HUILE D’ARGAN</strong><small>HUILE ALIMENTAIRE</small></div></div><div class="product-item-content"><span class="product-item-tag">HUILES</span><h3>Huile d’argan</h3><p>Une huile emblématique du terroir marocain, au caractère délicatement toasté et destinée aux usages culinaires.</p><div class="product-formats"><span class="formats-label">FORMATS DISPONIBLES</span><div class="format-list"><button class="format-button" data-weight="250 ml">250 ml</button><button class="format-button" data-weight="500 ml">500 ml</button><button class="format-button" data-weight="1 L">1 L</button><button class="format-button custom-format">+ Sur demande</button></div></div></div></article>
      <article class="product-item" data-product-name="Huile d’olive"><div class="product-item-image"><div class="product-placeholder"><span>ARAOUAA</span><strong>HUILE D’OLIVE</strong><small>HUILE ALIMENTAIRE</small></div></div><div class="product-item-content"><span class="product-item-tag">HUILES</span><h3>Huile d’olive</h3><p>Une huile alimentaire polyvalente, pensée pour accompagner les préparations et la cuisine du quotidien.</p><div class="product-formats"><span class="formats-label">FORMATS DISPONIBLES</span><div class="format-list"><button class="format-button" data-weight="250 ml">250 ml</button><button class="format-button" data-weight="500 ml">500 ml</button><button class="format-button" data-weight="1 L">1 L</button><button class="format-button custom-format">+ Sur demande</button></div></div></div></article>
    </div>`;
  story.parentNode.insertBefore(section,story);
  const footerUnivers=document.querySelector('.footer-nav > div:nth-child(2)');
  if(footerUnivers){const link=document.createElement('a');link.href='#huiles';link.textContent='Huiles';const autres=footerUnivers.querySelector('a[href="#autres"]');footerUnivers.insertBefore(link,autres||null);}
...
(function addAmlouCategory(){
  if(!document.body.classList.contains('products-page')) return;
  const nav=document.querySelector('.product-category-nav');
  const story=document.querySelector('.product-story');
  if(!nav || !story || document.querySelector('[data-section="amlou"]')) return;
  const filter=document.createElement('button');
  filter.className='catalog-filter';
  filter.dataset.category='amlou';
  filter.textContent='Amlou';
  const oilFilter=nav.querySelector('[data-category="huiles"]');
  nav.insertBefore(filter,oilFilter ? oilFilter.nextSibling : nav.querySelector('[data-category="autres"]'));
  const section=document.createElement('section');
  section.className='product-category-section category-amlou';
  section.dataset.section='amlou';
  section.id='amlou';
  section.innerHTML=`
    <div class="category-heading"><div class="category-heading-left"><span class="category-number">09</span><div><span class="product-item-tag">UNIVERS ARAOUAA</span><h2>Amlou <em>Signature</em></h2></div></div><p>Une collection d’Amlou inspirée du Souss, entre amandes torréfiées, fruits secs, miel et richesse de l’huile d’argan.</p></div>
    <div class="pantry-intro"><p>L’Amlou traditionnel est une spécialité du Souss préparée à partir d’amandes grillées, d’huile d’argan alimentaire et de miel. Des variantes gourmandes permettent ensuite d’explorer d’autres fruits secs.</p></div>
    <div class="product-items">
      <article class="product-item" data-product-name="Amlou traditionnel"><div class="product-item-image"><div class="product-placeholder"><span>ARAOUAA</span><strong>AMLOU</strong><small>AMANDES · ARGAN · MIEL</small></div></div><div class="product-item-content"><span class="product-item-tag">AMLOU</span><h3>Amlou traditionnel</h3><p>La recette emblématique du Souss associant amandes grillées, huile d’argan alimentaire et miel.</p><div class="product-formats"><span class="formats-label">FORMATS DISPONIBLES</span><div class="format-list"><button class="format-button" data-weight="100 g">100 g</button><button class="format-button" data-weight="250 g">250 g</button><button class="format-button" data-weight="500 g">500 g</button><button class="format-button" data-weight="1 kg">1 kg</button><button class="format-button custom-format">+ Sur demande</button></div></div></div></article>
      <article class="product-item" data-product-name="Amlou aux noix de cajou"><div class="product-item-image"><div class="product-placeholder"><span>ARAOUAA</span><strong>AMLOU CAJOU</strong><small>CAJOU · ARGAN · MIEL</small></div></div><div class="product-item-content"><span class="product-item-tag">AMLOU</span><h3>Amlou aux noix de cajou</h3><p>Une variante gourmande où la noix de cajou s’associe au miel et à l’huile d’argan alimentaire.</p><div class="product-formats"><span class="formats-label">FORMATS DISPONIBLES</span><div class="format-list"><button class="format-button" data-weight="100 g">100 g</button><button class="format-button" data-weight="250 g">250 g</button><button class="format-button" data-weight="500 g">500 g</button><button class="format-button" data-weight="1 kg">1 kg</button><button class="format-button custom-format">+ Sur demande</button></div></div></div></article>
      <article class="product-item" data-product-name="Amlou aux noisettes"><div class="product-item-image"><div class="product-placeholder"><span>ARAOUAA</span><strong>AMLOU NOISETTE</strong><small>NOISETTES · ARGAN · MIEL</small></div></div><div class="product-item-content"><span class="product-item-tag">AMLOU</span><h3>Amlou aux noisettes</h3><p>Une interprétation plus pralinée avec noisettes, huile d’argan alimentaire et miel.</p><div class="product-formats"><span class="formats-label">FORMATS DISPONIBLES</span><div class="format-list"><button class="format-button" data-weight="100 g">100 g</button><button class="format-button" data-weight="250 g">250 g</button><button class="format-button" data-weight="500 g">500 g</button><button class="format-button" data-weight="1 kg">1 kg</button><button class="format-button custom-format">+ Sur demande</button></div></div></div></article>
      <article class="product-item" data-product-name="Amlou aux cacahuètes"><div class="product-item-image"><div class="product-placeholder"><span>ARAOUAA</span><strong>AMLOU CACAHUÈTES</strong><small>CACAHUÈTES · MIEL</small></div></div><div class="product-item-content"><span class="product-item-tag">AMLOU</span><h3>Amlou aux cacahuètes</h3><p>Une version gourmande autour de la cacahuète et du miel, inspirée des variantes populaires de l’Amlou.</p><div class="product-formats"><span class="formats-label">FORMATS DISPONIBLES</span><div class="format-list"><button class="format-button" data-weight="100 g">100 g</button><button class="format-button" data-weight="250 g">250 g</button><button class="format-button" data-weight="500 g">500 g</button><button class="format-button" data-weight="1 kg">1 kg</button><button class="format-button custom-format">+ Sur demande</button></div></div></div></article>
    </div>`;
  story.parentNode.insertBefore(section,story);
  const footerUnivers=document.querySelector('.footer-nav > div:nth-child(2)');
  if(footerUnivers){const link=document.createElement('a');link.href='#amlou';link.textContent='Amlou';const oilLink=footerUnivers.querySelector('a[href="#huiles"]');footerUnivers.insertBefore(link,oilLink ? oilLink.nextSibling : footerUnivers.querySelector('a[href="#autres"]')||null);}
  const formats=section.querySelectorAll('.format-button:not(.custom-format)');
  formats.forEach(button=>button.addEventListener('click',()=>{button.classList.add('selected');setTimeout(()=>button.classList.remove('selected'),650);}));
})();
...
(function addHoneyCategory(){
  ...
  section.id='miels';
  section.innerHTML=`
    <div class="category-heading"><div class="category-heading-left"><span class="category-number">10</span><div><span class="product-item-tag">UNIVERS ARAOUAA</span><h2>Miels <em>Signature</em></h2></div></div><p>Une sélection de miels marocains aux profils distincts, choisis pour leur origine florale, leur caractère et leur expression du terroir.</p></div>
    <div class="pantry-intro"><p>Le miel « حر » désigne dans l’usage marocain un miel naturel. La collection met en avant plusieurs profils de terroir, du Daghmous au jujubier et au thym.</p></div>
    <div class="product-items">
      <article class="product-item" data-product-name="Miel حر naturel"><div class="product-item-image"><div class="product-placeholder"><span>ARAOUAA</span><strong>MIEL حر</strong><small>MIEL NATUREL</small></div></div><div class="product-item-content"><span class="product-item-tag">MIELS</span><h3>Miel حر naturel</h3><p>Un miel naturel au profil généreux, présenté comme une référence authentique de la collection.</p><div class="product-formats"><span class="formats-label">FORMATS DISPONIBLES</span><div class="format-list"><button class="format-button" data-weight="250 g">250 g</button><button class="format-button" data-weight="500 g">500 g</button><button class="format-button" data-weight="1 kg">1 kg</button><button class="format-button custom-format">+ Sur demande</button></div></div></div></article>
      <article class="product-item" data-product-name="Miel de Daghmous"><div class="product-item-image"><div class="product-placeholder"><span>ARAOUAA</span><strong>DAGHMOUS</strong><small>EUPHORBE</small></div></div><div class="product-item-content"><span class="product-item-tag">MIELS</span><h3>Miel de Daghmous</h3><p>Un miel d’Euphorbe résinifère, reconnu pour sa couleur ambrée et son goût puissant, avec une finale poivrée et légèrement piquante.</p><div class="product-formats"><span class="formats-label">FORMATS DISPONIBLES</span><div class="format-list"><button class="format-button" data-weight="250 g">250 g</button><button class="format-button" data-weight="500 g">500 g</button><button class="format-button" data-weight="1 kg">1 kg</button><button class="format-button custom-format">+ Sur demande</button></div></div></div></article>
      <article class="product-item" data-product-name="Miel de jujubier"><div class="product-item-image"><div class="product-placeholder"><span>ARAOUAA</span><strong>JUJUBIER</strong><small>SIDR · ZIZIPHUS</small></div></div><div class="product-item-content"><span class="product-item-tag">MIELS</span><h3>Miel de jujubier</h3><p>Un miel monofloral associé au jujubier, apprécié pour son caractère riche et sa signature florale.</p><div class="product-formats"><span class="formats-label">FORMATS DISPONIBLES</span><div class="format-list"><button class="format-button" data-weight="250 g">250 g</button><button class="format-button" data-weight="500 g">500 g</button><button class="format-button" data-weight="1 kg">1 kg</button><button class="format-button custom-format">+ Sur demande</button></div></div></div></article>
      <article class="product-item" data-product-name="Miel de thym"><div class="product-item-image"><div class="product-placeholder"><span>ARAOUAA</span><strong>MIEL DE THYM</strong><small>THYM</small></div></div><div class="product-item-content"><span class="product-item-tag">MIELS</span><h3>Miel de thym</h3><p>Un miel à dominante florale de thym, recherché pour son profil aromatique marqué.</p><div class="product-formats"><span class="formats-label">FORMATS DISPONIBLES</span><div class="format-list"><button class="format-button" data-weight="250 g">250 g</button><button class="format-button" data-weight="500 g">500 g</button><button class="format-button" data-weight="1 kg">1 kg</button><button class="format-button custom-format">+ Sur demande</button></div></div></div></article>
    </div>`;
  story.parentNode.insertBefore(section,story);
  const footerUnivers=document.querySelector('.footer-nav > div:nth-child(2)');
  if(footerUnivers){const link=document.createElement('a');link.href='#miels';link.textContent='Miels';const oilLink=footerUnivers.querySelector('a[href="#huiles"]');footerUnivers.insertBefore(link,oilLink||footerUnivers.querySelector('a[href="#autres"]')||null);}
  const formats=section.querySelectorAll('.format-button:not(.custom-format)');
  formats.forEach(button=>button.addEventListener('click',()=>{button.classList.add('selected');setTimeout(()=>button.classList.remove('selected'),650);}));
})();
